...
{% if wallet.private-key %}If that fails, you can recover it to different wallet using my Ethereum private key {{wallet.private-key| redactedOrBold}}.{% endif %}{% endif %}
{% else %}
{{undefined | redactedOrBold}}
{% endif %}
